...
namespace Spark
{
    ...
    VulkanCube::VulkanCube(VulkanRenderer& renderer, glm::vec3 position, const VulkanTexture& texture, glm::vec3 scale)
        : Cube(position, scale)
        ...
        , m_texture(texture)
    {
        createVertex3DBuffer(m_context, m_vertexBuffer, m_vertexBufferMemory, m_verticesOffset, m_indicesOffset, cube_vertices, cube_indices);
    }

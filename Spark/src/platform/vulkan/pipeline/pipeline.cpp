...
namespace Spark
{
	...
	void VulkanPipeline::createGraphicsPipeline(VkShaderModule vertexShader, VkShaderModule fragmentShader, VkPipelineVertexInputStateCreateInfo vertexInputInfo, VkPipelineLayout layout)
	{

...
{
    const VulkanTexture &texture0 = reinterpret_cast<const VulkanTexture &>(
        ResourceManager::loadTexture("texture0", "C:\\Users\\NadavT\\Pictures\\ball.png"));
    const VulkanTexture &texture1 = reinterpret_cast<const VulkanTexture &>(
        ResourceManager::loadTexture("texture1", "C:\\Users\\NadavT\\Pictures\\Untitled.png"));
